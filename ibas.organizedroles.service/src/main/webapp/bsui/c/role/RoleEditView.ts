...
import { IRoleEditView } from "../../../bsapp/role/index";

/**
 * 视图-Role
 */
export class RoleEditView extends ibas.BOEditView implements IRoleEditView {
    /** 删除数据事件 */
    ...
    /** 改变视图状态 */
    private changeViewStatus(data: bo.Role): void {
