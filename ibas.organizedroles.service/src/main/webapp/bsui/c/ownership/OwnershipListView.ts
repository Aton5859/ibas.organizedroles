    ...
    darw(): any {
        ...
        this.table = new sap.ui.table.Table("", {
            ...
            columns: [
                ...
                new sap.ui.table.Column("", {
                    label: ibas.i18n.prop("bo_ownership_self"),
                    template: new sap.m.Text("", {
                        wrapping: false
                    }).bindProperty("text", {
                        path: "self",
                ...
                new sap.ui.table.Column("", {
                    label: ibas.i18n.prop("bo_ownership_lowerlevel"),
                    template: new sap.m.Text("", {
                        wrapping: false
                    }).bindProperty("text", {
                        path: "lowerLevel",
                ...
                new sap.ui.table.Column("", {
                    label: ibas.i18n.prop("bo_ownership_equallevel"),
                    template: new sap.m.Text("", {
                        wrapping: false
                    }).bindProperty("text", {
                        path: "equalLevel",
                ...
                new sap.ui.table.Column("", {
                    label: ibas.i18n.prop("bo_ownership_higherlevel"),
                    template: new sap.m.Text("", {
                        wrapping: false
                    }).bindProperty("text", {
                        path: "higherLevel",
                ...
                new sap.ui.table.Column("", {
                    label: ibas.i18n.prop("bo_ownership_teams"),
                    template: new sap.m.Text("", {
                        wrapping: false
                    }).bindProperty("text", {
                        path: "teams",
                ...
                new sap.ui.table.Column("", {
                    label: ibas.i18n.prop("bo_ownership_others"),
                    template: new sap.m.Text("", {
                        wrapping: false
                    }).bindProperty("text", {
                        path: "others",
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.Ownership>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    */
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.deleteDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.Ownership>(that.table)
                            );
                        }
                    }),
                ],
