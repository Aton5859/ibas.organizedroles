...
namespace organizedroles {
    export namespace bo {
        ...
        export class Ownership extends ibas.BOSimple<Ownership> implements IOwnership {
            ...
            /** 获取-自身权限 */
            get self(): ibas.emAuthoriseType {
                return this.getProperty<ibas.emAuthoriseType>(Ownership.PROPERTY_SELF_NAME);
            }
            /** 设置-自身权限 */
            set self(value: ibas.emAuthoriseType) {
            ...
            /** 获取-部门-下级权限 */
            get lowerLevel(): ibas.emAuthoriseType {
                return this.getProperty<ibas.emAuthoriseType>(Ownership.PROPERTY_LOWERLEVEL_NAME);
            }
            /** 设置-部门-下级权限 */
            set lowerLevel(value: ibas.emAuthoriseType) {
            ...
            /** 获取-部门-同级权限 */
            get equalLevel(): ibas.emAuthoriseType {
                return this.getProperty<ibas.emAuthoriseType>(Ownership.PROPERTY_EQUALLEVEL_NAME);
            }
            /** 设置-部门-同级权限 */
            set equalLevel(value: ibas.emAuthoriseType) {
            ...
            /** 获取-部门-上级权限 */
            get higherLevel(): ibas.emAuthoriseType {
                return this.getProperty<ibas.emAuthoriseType>(Ownership.PROPERTY_HIGHERLEVEL_NAME);
            }
            /** 设置-部门-上级权限 */
            set higherLevel(value: ibas.emAuthoriseType) {
            ...
            /** 获取-团队权限 */
            get teams(): ibas.emAuthoriseType {
                return this.getProperty<ibas.emAuthoriseType>(Ownership.PROPERTY_TEAMS_NAME);
            }
            /** 设置-团队权限 */
            set teams(value: ibas.emAuthoriseType) {
                this.setProperty(Ownership.PROPERTY_TEAMS_NAME, value);
            }

            /** 映射的属性名称-角色权限 */
            static PROPERTY_RULES_NAME: string = "Rules";
            /** 获取-角色权限 */
            get rules(): ibas.emAuthoriseType {
                return this.getProperty<ibas.emAuthoriseType>(Ownership.PROPERTY_RULES_NAME);
            }
            /** 设置-角色权限 */
            set rules(value: ibas.emAuthoriseType) {
                this.setProperty(Ownership.PROPERTY_RULES_NAME, value);
            }

            /** 映射的属性名称-角色编码 */
            static PROPERTY_RULECODES_NAME: string = "RuleCodes";
            /** 获取-角色编码 */
            get ruleCodes(): string {
                return this.getProperty<string>(Ownership.PROPERTY_RULECODES_NAME);
            }
            /** 设置-角色编码 */
            set ruleCodes(value: string) {
                this.setProperty(Ownership.PROPERTY_RULECODES_NAME, value);
            }

            /** 映射的属性名称-其他情况权限 */
            static PROPERTY_OTHERS_NAME: string = "Others";
            /** 获取-其他情况权限 */
            get others(): ibas.emAuthoriseType {
                return this.getProperty<ibas.emAuthoriseType>(Ownership.PROPERTY_OTHERS_NAME);
            }
            /** 设置-其他情况权限 */
            set others(value: ibas.emAuthoriseType) {
