...
namespace organizedroles {
    export namespace bo {
        ...
        /** 组织-结构 */
        export class OrganizationalStructure extends ibas.BOSimple<OrganizationalStructure> implements IOrganizationalStructure {
            ...
            protected init(): void {
                ...
                this.objectCode = ibas.config.applyVariables(OrganizationalStructure.BUSINESS_OBJECT_CODE);
            }
        }

        /** 组织-角色 集合 */
        export class OrganizationalRoles extends ibas.BusinessObjects<OrganizationalRole, OrganizationalStructure> implements IOrganizationalRoles {
        ...
        /** 组织-角色 */
        export class OrganizationalRole extends ibas.BOSimpleLine<OrganizationalRole> implements IOrganizationalRole {
        ...
        /** 组织-角色-成员 集合 */
        export class RoleMembers extends ibas.BusinessObjects<RoleMember, OrganizationalRole> implements IRoleMembers {
        ...
        /** 组织-角色-成员 */
        export class RoleMember extends ibas.BOSimpleLine<RoleMember> implements IRoleMember {
