 ...
 * 
 */
public interface IOrganizationalStructure extends IBOSimple {
	 ...
	 * @return 值
	 */
	IOrganizationalRoles getOrganizationalRoles();
	 ...
	 *            值
	 */
	void setOrganizationalRoles(IOrganizationalRoles value);
