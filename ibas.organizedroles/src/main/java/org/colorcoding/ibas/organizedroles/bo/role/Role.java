package org.colorcoding.ibas.organizedroles.bo.role;
...
@XmlType(name = Role.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = Role.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
...
public class Role extends BusinessObject<Role> implements IRole {
	 ...
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 3454675969048076943L;
